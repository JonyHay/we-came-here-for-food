...
public class Sprite {
	...
	*/
    ...
    {
    	if (!render) return;
    	//g.setColor(new Color(200, 250, 200, 150));
	...
	*/
    ...
    public boolean boundingBoxCollision(Sprite s2) 
	{ 
	 return ((this.getX() + this.getWidth() > s2.getX()) && 
	 (this.getX() < (s2.getX() + s2.getWidth())) && 
	 ((this.getY() + this.getHeight() > s2.getY()) && 
	 (this.getY() < s2.getY() + s2.getHeight()))); 
